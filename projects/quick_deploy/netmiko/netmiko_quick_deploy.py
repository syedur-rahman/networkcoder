""" netmiko quick deploy
quickly deploy commands using the netmiko library """
...
class QuickDeploy:
    ...
    def deploy_commands(self):
        ...
        for device in self.devices:
            ...
            # configuration set
            # netmiko enables the use of sending bulk
            ...
            for command in self.commands:
                ...
                # generally used when there are show commands involved
                    ...
                    self.log[device].append([command, device_output])
...
def main():
    ...
    usr_msg = "# Quick Deploy - Netmiko Edition"
